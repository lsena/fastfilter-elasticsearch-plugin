 ...
 * implementing fast_filter scoring.
 */
    ...
    private static class MyFastFilterEngine implements ScriptEngine {
        ...
        public <T> T compile(
            ...
            if ("fast_filter".equals(scriptSource)) {
                ScoreScript.Factory factory = new FastFilterFactory();
        ...
        private static class FastFilterFactory implements ScoreScript.Factory,
                                                      ScriptFactory {
            @Override
